...
export const HomePage = () => {
  ...
  async function fetchArticles() {
    await fetch(
      `https://newsapi.org/v2/top-headlines?country=in&apiKey=a513f0749c814a0985990366feaa0f13`
    )
      .then((data) => {
  ...
  async function getCategoryNews(category) {
    await fetch(
      `https://newsapi.org/v2/top-headlines?country=in&category=${category}&apiKey=a513f0749c814a0985990366feaa0f13`
    )
      .then((data) => {
        data.json().then((result) => {
          setArticles(result.articles);
